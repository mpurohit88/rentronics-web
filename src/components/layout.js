...
import packages from "../images/categories/new-packages.svg";
import furniture from ".././images/categories/new-furniture.svg";
import appliances from ".././images/categories/new-appliances.svg";
import electronics from ".././images/categories/new-electronics.svg";
import fitness from ".././images/categories/new-fitness.svg";
import arrivals from ".././images/categories/new-arrivals.svg";
          ...
          <div className="pt-24">
            ...
            <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
              ...
              <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <p className="uppercase tracking-loose w-full">Own at Affordable Prices</p>
                <h1 className="my-4 text-5xl font-bold leading-tight">New Zealand's most Trusted Appliance Rental</h1>
                ...
                <form action={data.site.siteMetadata.github}>
                  <button type="submit" className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg">Shop Now</button>
                </form>
